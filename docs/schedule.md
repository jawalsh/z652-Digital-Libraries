...
### In Class
* Introduce course, syllabus, assignments. <!-- 20-30 minutes -->
* Check in on reading and responses. <!-- 5 minutes -->



## Week 2 _2020-09-02_: Text Objects, Part 1
### Before Class
<!-- #### Before Session 2 | Learning Outcome
You should be able to summarize Witten, et al.'s ideas about interfaces for textual objects, representing textual objects, and “textual images.”

#### To Accomplish Before Session 1
...
* Browse through the Omeka help at <http://info.omeka.net/build-a-website/>. Focus on the sections under “Build a Website–Start Here!”
...
## 1 November (week 11): Metadata Sharing and Linking
### Before Class:
1. Read the following:
...
<!--	[return to TEI/CBML and show linked data examples.]-->
